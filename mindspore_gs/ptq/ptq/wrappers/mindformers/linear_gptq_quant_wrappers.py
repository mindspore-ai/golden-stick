...
class GptqWeightQuantLinearCell(WeightQuantLinearCell):
    ...
    def reg_self():
        ...
        try:
            ...
            Quantizer.reg_layer_map(ColumnParallelLinearTPDP, GptqWeightQuantLinearCell, A16WxChecker())
            Quantizer.reg_layer_map(RowParallelLinearTPDP, GptqWeightQuantLinearCell, A16WxChecker())
        except ImportError:
            pass
