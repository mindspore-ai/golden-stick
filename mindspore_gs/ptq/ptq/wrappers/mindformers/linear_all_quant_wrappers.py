...
class AllQuantLinearCell(WeightQuantLinearCell):
    ...
    def reg_self():
        ...
        try:
            ...
            Quantizer.reg_layer_map(ColumnParallelLinearTPDP, AllQuantLinearCell, A8W8Checker())
            Quantizer.reg_layer_map(RowParallelLinearTPDP, AllQuantLinearCell, A8W8Checker())
        except ImportError:
            pass
