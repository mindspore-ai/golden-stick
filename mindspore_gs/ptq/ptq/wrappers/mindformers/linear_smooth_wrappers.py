...
class SmoothQuantLinearCell(SmoothLinearCell):
    ...
    def reg_self():
        ...
        try:
            ...
            LinearSmoothQuant.reg_layer_map(ColumnParallelLinearTPDP, SmoothQuantLinearCell, SmoothChecker())
            LinearSmoothQuant.reg_layer_map(RowParallelLinearTPDP, SmoothQuantLinearCell, SmoothChecker())
        except ImportError:
            pass
...
class AWQLinearCell(SmoothLinearCell):
    ...
    def reg_self():
        ...
        try:
            ...
            LinearSmoothQuant.reg_layer_map(ColumnParallelLinearTPDP, AWQLinearCell, AWQChecker())
            LinearSmoothQuant.reg_layer_map(RowParallelLinearTPDP, AWQLinearCell, AWQChecker())
        except ImportError:
            pass
    ...
    def reg_self():
        ...
        try:
            ...
            LinearAutoSmoother.reg_layer_map(RowParallelGroupLinear, SearchOutlierSuppressionLiteLinearCell,
                                             SearchOutlierSuppressionLiteChecker())
            LinearAutoSmoother.reg_layer_map(ColumnParallelLinearTPDP, SearchOutlierSuppressionLiteLinearCell,
                                             SearchOutlierSuppressionLiteChecker())
            LinearAutoSmoother.reg_layer_map(RowParallelLinearTPDP, SearchOutlierSuppressionLiteLinearCell,
                                             SearchOutlierSuppressionLiteChecker())
        except ImportError:
            pass
...
class AWQSmoothLinearCell(AWQLinearCell):
    ...
    def reg_self():
        ...
        try:
            ...
            LinearAutoSmoother.reg_layer_map(ColumnParallelLinearTPDP, AWQSmoothLinearCell, AWQSmoothChecker())
            LinearAutoSmoother.reg_layer_map(RowParallelLinearTPDP, AWQSmoothLinearCell, AWQSmoothChecker())
        except ImportError:
            pass
    ...
    def reg_self():
        ...
        try:
            ...
            LinearAutoSmoother.reg_layer_map(RowParallelGroupLinear, OutlierSuppressionPlusSmoothLinearCell,
                                             OutlierSuppressionPlusSmoothChecker())
            LinearAutoSmoother.reg_layer_map(ColumnParallelLinearTPDP, OutlierSuppressionPlusSmoothLinearCell,
                                             OutlierSuppressionPlusSmoothChecker())
            LinearAutoSmoother.reg_layer_map(RowParallelLinearTPDP, OutlierSuppressionPlusSmoothLinearCell,
                                             OutlierSuppressionPlusSmoothChecker())
        except ImportError:
            pass
    ...
    def reg_self():
        ...
        try:
            ...
            LinearAutoSmoother.reg_layer_map(RowParallelGroupLinear, OutlierSuppressionPlusLinearCell,
                                             OutlierSuppressionPlusChecker())
            LinearAutoSmoother.reg_layer_map(ColumnParallelLinearTPDP, OutlierSuppressionPlusLinearCell,
                                             OutlierSuppressionPlusChecker())
            LinearAutoSmoother.reg_layer_map(RowParallelLinearTPDP, OutlierSuppressionPlusLinearCell,
                                             OutlierSuppressionPlusChecker())
        except ImportError:
            pass
