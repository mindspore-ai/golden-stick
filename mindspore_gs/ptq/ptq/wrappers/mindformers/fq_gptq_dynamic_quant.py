...
class FakeQuantA8W4DynamicLinearMethod(LinearMethodBase):
...
class FakeQuantW4A8DynamicWrapper(WrapperCell):
    """FakeQuantWrapper"""
    @staticmethod
    def reg_self():
        """reg_self"""
...
class FakeQuantW4A8DynamicLinearCell(FakeQuantLinearCell):
    ...
    def __init__(self, layer_name, linear: LinearBase, context, cfg: InnerPTQConfig):
        ...
        self.quant_method = FakeQuantA8W4DynamicLinearMethod(layer_name, linear.quant_method, self.compute_dtype,
