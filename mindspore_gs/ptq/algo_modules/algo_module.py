...
from mindspore_gs.ptq.basic_functions.processor import Processor, transform_network_inplace
...
class AlgoModule:
    ...
    def process(self, decoder_layer_name: str, decoder_layer, **kwargs):
        ...
        transform_network_inplace(decoder_layer, QuantCell, transform_fn, decoder_layer_name)
