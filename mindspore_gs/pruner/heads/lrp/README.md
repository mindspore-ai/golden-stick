...
We provide a code example for LRP pruning of Bert model in [run_sample_bert.py](https://atomgit.com/mindspore/golden-stick/blob/master/mindspore_gs/pruner/heads/lrp/bert/samples/run_sample_bert.py) file. It can be run using the following shell command
