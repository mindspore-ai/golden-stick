...
class SymbolTree:
    ...
    def create(cls, network):
        ...
        Note:
            ...
            interfaces like :func:`mindspore_gs.quantization.rewrite.Node.get_inputs` and
            :func:`mindspore_gs.quantization.rewrite.Node.get_users` .
    ...
    def print_node_tabulate(self, all_nodes: bool = False):
        ...
        - **node type** (str): The type of node, refer to class:`mindspore_gs.quantization.rewrite.NodeType` .
