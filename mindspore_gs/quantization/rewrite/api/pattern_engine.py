...
class VarNode(PatternNode):
    ...
    def __init__(self):
        super().__init__("placeholder", Cell, [])
...
class Replacement(abc.ABC):
    ...
    Examples:
        >>> from mindspore_gs.quantization.rewrite import Replacement, Node
...
class PatternEngine:
    ...
    @staticmethod
    def _multi_replace_cellcontainer(stree, cellcontainer, node, matched_dict, new_nodes):  # pylint: disable=unused-argument
