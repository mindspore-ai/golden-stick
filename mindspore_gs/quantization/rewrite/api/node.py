...
class Node:
    ...
    def create_call_cell(cell: Cell, targets: List[Union[ScopedValue, str]], args: List[ScopedValue] = None,
        ...
        Examples:
            >>> from mindspore_gs.quantization.rewrite import SymbolTree, ScopedValue
            ...
            >>> print(type(new_node))
            <class 'mindspore_gs.quantization.rewrite.api.node.Node'>
        """
    ...
    def create_call_function(function: FunctionType, targets: List[Union[ScopedValue, str]],
        ...
        # Access internal implementation method for node creation
        return Node(NodeImpl._create_call_function(function, targets, args, kwargs))  # pylint: disable=protected-access
    ...
    def set_arg_by_node(self, arg_idx: int, src_node: 'Node', out_idx: Optional[int] = None):
        ...
        belong_symbol_tree: SymbolTreeImpl = self._node.get_belong_symbol_tree()
        if belong_symbol_tree is None:
            # Access internal node for low-level operation
            self._node.set_arg_by_node(arg_idx, src_node._node, out_idx)  # pylint: disable=protected-access
        else:
    ...
    def get_node_type(self) -> NodeType:
        ...
        See :class:`mindspore_gs.quantization.rewrite.NodeType` for details on node types.
    ...
    def get_instance(self):
        """
        Get the instance object of current node.
        
        For CallCell nodes, returns the Cell instance.
        For CallPrimitive nodes, returns the Primitive instance.
        For CallFunction nodes, returns the function object.
        
        Returns:
            Instance object (Cell, Primitive, or function) of current node, or None for other node types.
        """
    ...
    def get_symbol_tree(self) -> 'SymbolTree':
        ...
        Examples:
            ...
            <class 'mindspore_gs.quantization.rewrite.api.symbol_tree.SymbolTree'>
        """
        from .symbol_tree import SymbolTree  # pylint: disable=import-outside-toplevel
