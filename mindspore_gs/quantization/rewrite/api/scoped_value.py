...
class ValueType(Enum):  # pylint: disable=invalid-name
    """
    ...
    # constant type
    ConstantValue = 0  # pylint: disable=invalid-name
    # container type
    TupleValue = 20  # pylint: disable=invalid-name
    ListValue = 21  # pylint: disable=invalid-name
    DictValue = 22  # pylint: disable=invalid-name
    # variable type
    NamingValue = 40  # pylint: disable=invalid-name
    CustomObjValue = 41  # pylint: disable=invalid-name
    # unsupported type
    UnsupportedValue = 50  # pylint: disable=invalid-name
