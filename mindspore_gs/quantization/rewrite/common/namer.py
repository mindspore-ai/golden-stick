...
class TargetNamer(Namer):
    ...
    def get_unique_name(self, origin_name: str) -> str:
        ...
        Returns:
            A string represents unique-name.
        """
        return super().get_name(origin_name)
...
class NodeNamer(Namer):
    ...
    def get_name(self, node_or_name: Union[Node, str]) -> str:  # pylint: disable=arguments-renamed
        """
...
class ClassNamer(Namer):
    ...
    def get_name(self, origin_name: str) -> str:
        ...
        return super().get_name(origin_name + self._prefix)
    ...
    def add_name(self, name: str):
        ...
        super().add_name(name + self._prefix)
