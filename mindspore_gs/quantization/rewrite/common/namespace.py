...
def add_subtree_blacklist(cls):
    """
    Add a class to the subtree blacklist.
    
    Elements in the blacklist will not be converted to symbol tree.
    
    Args:
        cls: Class type to add to the blacklist
    """
    if cls not in _subtree_black_list:
        _subtree_black_list.append(cls)
