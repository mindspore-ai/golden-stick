...
class StrChecker(ast.NodeVisitor):  # pylint: disable=invalid-name
    """
...
class AstAssignFinder(ast.NodeVisitor):  # pylint: disable=invalid-name
    """
...
class AstClassFinder(ast.NodeVisitor):  # pylint: disable=invalid-name
    """
...
class AstFunctionFinder(ast.NodeVisitor):  # pylint: disable=invalid-name
    """
...
class AstImportFinder(ast.NodeVisitor):  # pylint: disable=invalid-name
