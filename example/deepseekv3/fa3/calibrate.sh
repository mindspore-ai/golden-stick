...
cal_path=${base_path}/../../../tests/data/calibrate-dataset/calibrate.jsonl
calibrate_path=${base_path}/run_fa3.py
...
msrun --worker_num=${worker_num} \
      ...
      --join=False \
      --log_dir=calibrate_fa3_log \
      python ${calibrate_path} \
            --config ${yaml} \
            -t calibrate \
            -s ${cal_path} > log_calibrate_fa3 2>&1 &