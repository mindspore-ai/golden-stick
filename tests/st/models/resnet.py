...
"""
ResNet.
Copied from models, because ResNet in models rely on config which will fail CI because of unrecognized arguments.

Resnet152 and optimizer Thor is not supported.
"""
