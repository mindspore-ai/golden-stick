...
class TestSafeTensorsMgr:
    ...
    def test_distributed_mode_construct(self):
        ...
        with patch('mindspore_gs.ptq.models.safetensors_mgr.get_rank', return_value=1):
            with patch('mindspore_gs.ptq.models.safetensors_mgr.get_group_size', return_value=4):
    ...
    def test_distributed_save(self):
        ...
        with patch('mindspore_gs.ptq.models.safetensors_mgr.get_rank', return_value=0):
            with patch('mindspore_gs.ptq.models.safetensors_mgr.get_group_size', return_value=2):
                with patch('mindspore.ops.Barrier') as mock_barrier_class:
                    mock_barrier = MagicMock()
                    mock_barrier_class.return_value = mock_barrier
    ...
    def test_runtime_error_handling(self):
        ...
        with patch('mindspore_gs.ptq.models.safetensors_mgr.get_rank',
                   side_effect=RuntimeError("Not in distributed mode")):
            with patch('mindspore_gs.ptq.models.safetensors_mgr.get_group_size',
                       side_effect=RuntimeError("Not in distributed mode")):
