...
from mindspore_gs.quantization.rewrite import ScopedValue, Node, SymbolTree
from mindspore_gs.quantization.rewrite import PatternEngine, PatternNode, Replacement, VarNode
...
class ChainNetwork(Cell):
    """ChainNetwork class for testing."""
    def __init__(self):
...
def test_one_to_multi_chain_pattern():
    ...
    class BnReplacement(Replacement):
        """Replacement for BatchNorm2d pattern."""
        def build(self, pattern: PatternNode, is_chain_pattern: bool, matched: OrderedDict) -> [Node]:
...
def test_tree_pattern():
    ...
    class AddReluReplacement(Replacement):
        """Replacement for Add-ReLU pattern."""
        def build(self, pattern: PatternNode, is_chain_pattern: bool, matched: OrderedDict) -> [Node]:
            assert is_chain_pattern
...
class TreeNetwork2(Cell):
    """TreeNetwork2 class for testing."""
    def __init__(self):
        """Method implementation."""
        super().__init__()
...
class MultiInputPattern(PatternEngine):
    """MultiInputPattern class for testing."""
    class MultiInputReplacement(Replacement):
        """Replacement for multi-input pattern."""
        def build(self, pattern: PatternNode, is_chain_pattern: bool, matched: OrderedDict) -> [Node]:
...
class TreeNetwork3(Cell):
    """TreeNetwork3 class for testing."""
    def __init__(self):
        """Method implementation."""
        super().__init__()
        self.conv1 = Conv2d(16, 16, 1)
