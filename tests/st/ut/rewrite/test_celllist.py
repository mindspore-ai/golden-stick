...
# ============================================================================
"""Test Celllist tests for CellList."""

from mindspore import nn
from mindspore_gs.quantization.rewrite import SymbolTree, NodeType, Node

class CellListSubNet(nn.Cell):
    """CellListSubNet class for testing."""
    def __init__(self):
...
class ListOfCellSubNet(nn.Cell):
    """ListOfCellSubNet class for testing."""
    def __init__(self):
        """Method implementation."""
        super().__init__()
        self.relu = nn.ReLU()
...
class ListOfCellNet(nn.Cell):
    """ListOfCellNet class for testing."""
    def __init__(self):
        """Method implementation."""
        super().__init__()
        self.conv = nn.Conv2d(16, 16, 3)
