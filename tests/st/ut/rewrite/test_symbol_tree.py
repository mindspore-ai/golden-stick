...
class Network(Cell):
    """Network for testing SymbolTree."""
    def __init__(self):
        super().__init__()
...
def create_symbol_tree():
    """Helper function to create a SymbolTree for testing."""
    net = Network()
    ...
    body_idx = 0
    if ast_class.body and isinstance(ast_class.body[0], ast.Expr) and isinstance(ast_class.body[0].value, ast.Constant):
        body_idx = 1
    ast_init_func = ast_class.body[body_idx]
    assert isinstance(ast_init_func, ast.FunctionDef)
    ast_construct_func = ast_class.body[body_idx + 1]
...
class SubSubNet(nn.Cell):
    """SubSubNet for testing nested networks."""
    def __init__(self):
        super().__init__()
        self.relu = nn.ReLU()
        self.abs = ops.Abs()
...
class SubNet(nn.Cell):
    """SubNet for testing nested networks."""
    def __init__(self):
        super().__init__()
...
class MyNet(nn.Cell):
    """MyNet for testing nested networks."""
    def __init__(self):
        super().__init__()
        self.relu = nn.ReLU()
        self.sub_net = SubNet()
...
class SubSubNet1(nn.Cell):
    """SubSubNet1 for testing nested networks."""
    def __init__(self):
        super().__init__()
        self.relu = nn.ReLU()
        self.abs = ops.Abs()
...
class SubNet1(nn.Cell):
    """SubNet1 for testing nested networks."""
    def __init__(self):
        super().__init__()
...
class MyNet1(nn.Cell):
    """MyNet1 for testing nested networks."""
    def __init__(self):
        super().__init__()
        self.relu = nn.ReLU()
