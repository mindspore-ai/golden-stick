"""Test for subtree operations in ResNet-like networks."""

from collections import OrderedDict

from mindspore import nn
from mindspore.ops import operations as P
from mindspore_gs.quantization.rewrite import SymbolTree, PatternEngine, Replacement, PatternNode, Node, ScopedValue
from mindspore_gs.quantization.rewrite.api.node_type import NodeType
...
class ConvBnReplace(Replacement):
    """ConvBnReplace class for testing."""
...
class ConvBnPattern(PatternEngine):
    """ConvBnPattern class for testing."""
    def __init__(self):
...
class CellBlock(nn.Cell):
    ...
    def __init__(self, in_channel, out_channel, stride=1,):  # pylint: disable=unused-argument
        """Method implementation."""
        super().__init__()
...
class ForNetWithSubTree(nn.Cell):
    """ForNetWithSubTree class for testing."""
    def __init__(self):
        """Method implementation."""
        super().__init__()
