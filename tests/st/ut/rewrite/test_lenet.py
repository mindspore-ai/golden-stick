...
# ============================================================================
"""Test Lenet tests for LeNet."""

from collections import OrderedDict

from mindspore import nn
from mindspore.common.initializer import Normal
from mindspore_gs.quantization.rewrite import SymbolTree, PatternEngine, Replacement, PatternNode, Node


class LeNet5(nn.Cell):
    """LeNet5 class for testing."""
...
class ConvActReplace(Replacement):
    """ConvActReplace class for testing."""
...
class ConvReLUPattern(PatternEngine):
    """ConvReLUPattern class for testing."""
    def __init__(self):
        """Method implementation."""
...
def test_lenet():
    ...
    assert len(stree.get_handler()._nodes) == original_nodes_size - 2  # pylint: disable=protected-access
