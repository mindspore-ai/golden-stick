...
# ============================================================================
"""Test Generate Codes tests."""

import numpy as np

from mindspore import nn, ops, Tensor
from mindspore_gs.quantization.rewrite import SymbolTree, Node, ScopedValue
...
class TransformerEncoderLayer(nn.Cell):
    """TransformerEncoderLayer class for testing."""
    def __init__(self):
        """Method implementation."""
        super().__init__()
        self.relu = nn.ReLU()
...
class IfInInitNetSubNet(nn.Cell):
    """IfInInitNetSubNet class for testing."""
...
class TransformerEncoderLayer2(nn.Cell):
    """TransformerEncoderLayer2 class for testing."""
    def __init__(self):
        """Method implementation."""
        super().__init__()
        self.relu = nn.ReLU()
...
class IfInInitNetSubNet2(nn.Cell):
    """IfInInitNetSubNet2 class for testing."""
    def __init__(self, use_moe):
        """Method implementation."""
        super().__init__()
        self.use_moe = use_moe
...
class IfInInitNet2(nn.Cell):
    """IfInInitNet2 class for testing."""
    def __init__(self):
        """Method implementation."""
        super().__init__()
...
class TransformerEncoderLayer3(nn.Cell):
    """TransformerEncoderLayer3 class for testing."""
    def __init__(self):
        """Method implementation."""
        super().__init__()
        self.relu = nn.ReLU()
...
class IfInInitNetSubNet3(nn.Cell):
    """IfInInitNetSubNet3 class for testing."""
    def __init__(self, use_moe):
        """Method implementation."""
        super().__init__()
        self.use_moe = use_moe
...
class IfInInitNet3(nn.Cell):
    """IfInInitNet3 class for testing."""
    def __init__(self):
        """Method implementation."""
        super().__init__()
...
class TestAnnotationSubNet(nn.Cell):
    """TestAnnotationSubNet class for testing."""
    def __init__(self):
        """Method implementation."""
        super().__init__()
        self.relu = nn.ReLU()
...
class TestAnnotationNet(nn.Cell):
    """TestAnnotationNet class for testing."""
    def __init__(self):
        """Method implementation."""
        super().__init__()
        self.relu = nn.ReLU()
...
class NetWithStatic(nn.Cell):
    """NetWithStatic class for testing."""
...
class SubNetWithStatic(nn.Cell):
    """SubNetWithStatic class for testing."""
    def __init__(self):
        """Method implementation."""
        super().__init__()
        self.relu = nn.ReLU()
...
class NetWithSubNetStatic(SubNetWithStatic):
    """NetWithSubNetStatic class for testing."""
    @staticmethod
    def static_func(x):
        """Method for testing."""
        return x
