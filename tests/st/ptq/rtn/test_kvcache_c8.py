...
def test_apply_convert(device, mode):
    ...
    assert key_fake_quant.quant_dtype() == QuantDtype.INT8
    ...
    assert value_fake_quant.quant_dtype() == QuantDtype.INT8
...
def kv_predict_llama2_2stage(device, mode, model_parallel):
