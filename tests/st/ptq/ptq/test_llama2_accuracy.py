...
@pytest.mark.platform_arm_ascend910b_training
@pytest.mark.env_single
def test_ptq_llama2_mix_quant_accuracy():
    """
    Feature: test mixture of quantizaiton method in two stages with two cards.
    Description: apply mixture of quantizaiton method on llama2 and check score.
    Expectation: score is good.
    """
    ptq_predict_2stage_2p_run("attn_a8w8c8_attn_a16w8c8_ffn_a8dyw8c8")
